...
## `loop:` templates that export the C-linkage entry points the core expects
## (setup also runs NimMain to init the Nim runtime).
##
## Serial (imported and re-exported from serial.nim) covers communication.
## 
## TODO: add WIFI and USB bindings
